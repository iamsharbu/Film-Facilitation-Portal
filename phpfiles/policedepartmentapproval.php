...
table {
 ...
 <div class="container-fluid">
   <h2 style="text-align:center;">Film Approval Applications - POLICE</h2>
   ...
   <table class="table table-hover">
     ...
     <tbody>
       <tr>
         ...
         <td><form class="" action="policedepartmentupdate.php" method="post">
           <div class="appbtn">
...
<?php
  ...
  header('Location: policedepartment.php');
}
?>
