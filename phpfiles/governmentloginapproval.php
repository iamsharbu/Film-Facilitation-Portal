...
if(isset($_SESSION['g_id'])){
  ...
  table {
   ...
   <div class="container-fluid">
     <h2 style="text-align:center;">Film Approval Applications - GOVERNMENT</h2>
     ...
     <table class="table table-hover">
       ...
       <tbody>
         <tr>
           ...
           <td><form class="" action="governmentloginupdate.php" method="post">
             <div class="appbtn">
  ...
  <?php
    ...
    header('Location: governmentlogin.php');
  }
  ?>
